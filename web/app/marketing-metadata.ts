...
/**
 * The Twitter/X handle for card attribution (twitter:site / twitter:creator).
 * Uses the project's brand handle. (No `if`/conditional — declarative per the owner rule.)
 */
const TWITTER_HANDLE = '@access0x1' as const;
