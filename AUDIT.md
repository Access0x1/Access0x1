...
_Last updated: 2026-07-26 (test-count refresh: 2,068 Foundry contract tests + 2,106 web/SDK unit tests; ten-chain mirror incl. zkSync Sepolia 300 and 0G Galileo 16602; the v4 SwapReceiptHook + ENS PaymentResolver deployed + source-verified on Ethereum Sepolia)._
