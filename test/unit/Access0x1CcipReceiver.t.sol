...
contract Access0x1CcipReceiverTest is Test {
    ...
    function test_AdvertisesTheCcipReceiverInterface() public view {
        assertTrue(
            receiver.supportsInterface(type(ICcipReceiver).interfaceId), "IAny2EVMMessageReceiver"
        );
    ...
    function test_InterfaceIdEqualsTheCcipReceiveSelector() public pure {
        ...
        assertEq(
            type(ICcipReceiver).interfaceId, expected, "id must be the ccipReceive selector alone"
        );
    }
