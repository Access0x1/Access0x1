...
/// @author Access0x1
/// @notice Recurring, USD-priced, tiered billing — the on-chain expression of the YourApp
...
contract Access0x1Subscriptions is IAccess0x1Subscriptions, Ownable2Step, ReentrancyGuard {
    ...
    ///         Mirrors YourApp's grace window (tier survives PAST_DUE, demotes only at UNPAID).
    ...
    /// @inheritdoc IAccess0x1Subscriptions
    /// @dev Immediate, no proration (the YourApp downgrade rule). Setting CANCELED is the on-chain
