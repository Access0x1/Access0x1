...
> and on a public branch from commit #1. **The CREATE3 mirror (one address `0xe92244e3…` on every chain) is live on ten testnets (Arc 5042002, Base Sepolia 84532, Ethereum Sepolia 11155111, Optimism Sepolia 11155420, Avalanche Fuji 43113, Robinhood 46630, Arbitrum Sepolia 421614, Celo Sepolia 11142220, ZKsync Sepolia 300 via the dedicated EraVM path, 0G Galileo 16602) and source-verified on seven of those ten; two additional earlier chains (Ethereum Hoodi 560048, Tempo 42431) carry pre-mirror per-chain deploys — twelve chains deployed in total. Every address is read straight from a committed `broadcast/DeployAll.s.sol/<chainId>/` record (law #4 — an address that isn't on-chain isn't claimed); the `MIRROR-STATUS` table below (regenerated by `make sync`) plus the source-verified table under Deployments are the live source of truth.** More chains (Polygon Amoy, Scroll Sepolia, …) are per-chain ready (`make deploy-<chain>`) but not yet broadcast. **No mainnet deployments and no mainnet claims.**
...
ten testnets** and the `Access0x1Router` proxy is **source-verified on seven of them** (confirmed on
each chain's own block explorer — all but Avalanche Fuji, zkSync Sepolia and 0G Galileo, whose
...
Two earlier chains (Tempo Moderato `42431`, Ethereum Hoodi `560048`) carry **pre-mirror, per-chain**
...
| Tempo Testnet (Moderato) (42431) | `Access0x1Router` * | [`0x60eb647d166b70662e0567551af7e575f13e8008`](https://explore.testnet.tempo.xyz/address/0x60eb647d166b70662e0567551af7e575f13e8008) |
| Tempo Testnet (Moderato) (42431) | `SessionGrant` * | [`0xa5982ea8842eea97c6e313a5f75fd8cf72c69aad`](https://explore.testnet.tempo.xyz/address/0xa5982ea8842eea97c6e313a5f75fd8cf72c69aad) |
| Tempo Testnet (Moderato) (42431) | `PaymentLanes` * | [`0xfd75f29369a29800fad5a5172cd8a8c4b9cc0f1b`](https://explore.testnet.tempo.xyz/address/0xfd75f29369a29800fad5a5172cd8a8c4b9cc0f1b) |
| Tempo Testnet (Moderato) (42431) | `HouseTokenFactory` * | [`0x3d5247b4d5d1947c7b9c82b27f20246da9923238`](https://explore.testnet.tempo.xyz/address/0x3d5247b4d5d1947c7b9c82b27f20246da9923238) |
| Tempo Testnet (Moderato) (42431) | `Access0x1Subscriptions` * | [`0x3a43171f6d503ab314366d19b7ddc7aa861125f2`](https://explore.testnet.tempo.xyz/address/0x3a43171f6d503ab314366d19b7ddc7aa861125f2) |
| Tempo Testnet (Moderato) (42431) | `Access0x1Bookings` * | [`0x1db513ec23bc7de46afd6dae5133de14d8a62bf8`](https://explore.testnet.tempo.xyz/address/0x1db513ec23bc7de46afd6dae5133de14d8a62bf8) |
| Tempo Testnet (Moderato) (42431) | `Access0x1Invoices` * | [`0x4e099b81a9a46a99378ac70cad195bf8e25f0c82`](https://explore.testnet.tempo.xyz/address/0x4e099b81a9a46a99378ac70cad195bf8e25f0c82) |
| Tempo Testnet (Moderato) (42431) | `Access0x1GiftCards` * | [`0x1001dc04da8706d53b24389c3348ca512a5ba6b7`](https://explore.testnet.tempo.xyz/address/0x1001dc04da8706d53b24389c3348ca512a5ba6b7) |
...
| | |
| --- | --- |
| Tests | **2,059 green** (Foundry) — unit · attack · invariant — plus 1,923 web/SDK unit tests |
...
Chainlink contracts 1.5.0 (Data Feeds + CRE). **Deployed on ten testnets via the CREATE3 mirror (one address `0xe92244e3…` on every chain); source-verified on seven — Arc, Base Sepolia, Ethereum Sepolia, Optimism Sepolia, Arbitrum Sepolia, Celo Sepolia, and Robinhood Chain** (Avalanche Fuji, zkSync Sepolia and 0G Galileo deployed, verification pending) — all **testnets, no mainnet deployments**.
