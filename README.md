...
[![Tests](https://img.shields.io/badge/Tests-2059%20passing-44CC11?style=for-the-badge)](https://github.com/Access0x1/Access0x1/actions/workflows/test.yml)
...
make test              # 2,059 tests, all green
```
...
| | |
| --- | --- |
| Tests | **2,059 green** (Foundry) — unit · attack · invariant — plus 1,847 web/SDK unit tests |
