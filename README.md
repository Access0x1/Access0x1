...
![Tests](https://img.shields.io/badge/Tests-1373%20passing-44CC11?style=for-the-badge)
...
test/                        # unit · attack · invariant (1,373 tests)
```
...
make test              # 1,373 tests, all green
```
...
| | |
| --- | --- |
| Tests | **1,373 green** — unit · attack · invariant suites |
