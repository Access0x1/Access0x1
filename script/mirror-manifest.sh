...
# The 19 UUPS contracts (DeployAll deploys each as .impl + .proxy via _deployUUPS),
...
UUPS=(
  ...
  GaslessPayIn Refunds SplitSettler Access0x1Rebates Access0x1SponsorRegistry Receivables PriceOracleAdapter
)
