...
- One-line FLAG notes when a unit slips, a seam threatens the floor, or copy drifts from truth (money-safety invariant #4) — routed to the owner, never silently absorbed.
